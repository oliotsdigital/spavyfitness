...
export default function QuickViewModal({ product, onClose, onInquireQuote }: QuickViewModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="bg-zinc-900 border border-zinc-700 rounded-lg max-w-2xl w-full p-6 relative text-zinc-100 shadow-2xl space-y-4">
        <button
          onClick={onClose}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="border-t border-zinc-800 pt-3 text-xs space-y-1">
              <p><strong className="text-white">Manufacturer:</strong> Spavy Fitness Equipments PVT. LTD.</p>
              <p><strong className="text-white">Warranty:</strong> Lifetime Frame / 2 Year Components</p>
              <p><strong className="text-white">Availability:</strong> In Stock - Ships within 24 Hrs</p>
            </div>
